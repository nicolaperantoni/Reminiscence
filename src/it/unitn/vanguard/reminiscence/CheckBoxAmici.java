...
public class CheckBoxAmici extends Activity{
		...
		String [] genre={"party lol","toni champa","lollosissimo lui","san girolamo","peter pan","lol","lol","lol","lol","lol","lol","lol","lol","lol","lol","lol","lol"};
		...
		private void initializeButtons() {
			...
			invia_mail.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					Toast.makeText(getApplicationContext(), "Funzione non disponibile!",
